 ...
 * @version    SVN: $Id: Factory.php 1002 2011-05-18 16:38:59Z chrismcband@gmail.com $
...
class PHPFrame_MVC_Factory
{
     ...
     * @since  1.0
     */
    public static function getView($name, $layout='', $component=null)
    {
        $component_name = $component ? $component : PHPFrame::Request()->getComponentName();
