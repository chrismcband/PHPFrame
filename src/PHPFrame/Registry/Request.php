 ...
 * @version    SVN: $Id: Request.php 1027 2012-05-25 14:34:57Z chrismcband $
...
class PHPFrame_Registry_Request extends PHPFrame_Registry
{
    ...
    public function getComponentName() 
    {
        ...
        if (empty($this->_array['request']['component'])) {
            $this->_array['request']['component'] = 'com_roommanager';
        }
