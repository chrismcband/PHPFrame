 ...
 * @version    SVN: $Id: XMLRPC.php 1049 2013-09-13 16:57:59Z chrismcband@gmail.com $
...
class PHPFrame_Client_XMLRPC implements PHPFrame_Client_IClient
{
    ...
    public function populateRequest() 
    {
        ...
        if (empty($HTTP_RAW_POST_DATA)){
        	$msg = "Oops...something went wrong! Please close your browser";
        	$msg .= " and try again.";
        	echo $msg;
        	exit;
        } else {
...
//            $this->_checkAPIPermisssions();
    ...
    private function _parseXMLRPC($xml) 
    {
        ...
        $ismatched = preg_match('/^([a-zA-Z]+)(\.([a-zA-Z_]+[a-zA-Z_0-9]+))?$/', $methodName, $matches);
