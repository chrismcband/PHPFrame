 ...
 * @version    SVN: $Id: RPC.php 881 2009-12-09 17:44:54Z chrismcband $
...
class PHPFrame_Document_RPC extends PHPFrame_Document_XML
{
    ...
    public function render(PHPFrame_MVC_View $view, $apply_theme=null) 
    {
    	...
    	if (
    		...
    		if ($summary[0] == 'error')
    		{
    			PHPFrame_Debug_Logger::write("Sending rpc fault due to event error in system");
    ...
    {
    	if (!empty($node_value) || $node_value==0)
    	{
