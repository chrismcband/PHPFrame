 ...
 * @version    SVN: $Id: Field.php 1064 2014-11-12 12:39:35Z chrismcband $
...
class PHPFrame_Database_Field
{
    ...
    {
        // Handle NULL values
        if (!is_null($value) && (!is_array($value) || array_keys($value) === range(0, count($value) - 1))) {
            $value = preg_replace("'NULL'", "NULL", $value);
        }
