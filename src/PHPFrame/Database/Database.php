 ...
 * @version    SVN: $Id: Database.php 1051 2013-09-22 16:18:29Z chrismcband $
...
class PHPFrame_Database extends PHPFrame_Base_Subject
{
    ...
    public function query($sql, $params=array(), $fetch_mode=self::FETCH_STMT) 
    {
        ...
        try {
            ...
            //log query
//            PHPFrame_Debug_Logger::write("QUERY: $sql PARAMS: ".print_r($params, true));
    ...
    private function _connect() {
        try {
            // Acquire PDO object
			// PHPFrame_Debug_Logger::write($this->_dsn);			
            $this->_pdo = new PDO($this->_dsn->toString(), $this->_db_user, $this->_db_pass);
        }
        catch (PDOException $e) {
