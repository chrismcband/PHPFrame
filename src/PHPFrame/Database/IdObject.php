 ...
 * @version    SVN: $Id: IdObject.php 972 2010-12-02 12:29:35Z chrismcband@gmail.com $
...
class PHPFrame_Database_IdObject
{
    ...
    public function from($table)
    {
        ...
        preg_match("/([a-zA-Z_0-9\#\.]+) (as) ([a-zA-Z_]+)/i", $table, $matches);
        if (count($matches) == 4) {
    ...
    public function join($join)
    {
        ...
        // Validate input type and set internal property
        $pattern = "/^([a-zA-Z]*[ ]{0,1}JOIN) ([a-zA-Z0-9_ \#\.\(\)]+)/";
